...
class ColumnRefTranslator : public ScalarTranslator {
  public:
    ColumnRefTranslator(CMemoryPool *mp, CMDAccessor *mda) : ScalarTranslator(mp, mda) {}
    virtual ~ColumnRefTranslator() = default;
