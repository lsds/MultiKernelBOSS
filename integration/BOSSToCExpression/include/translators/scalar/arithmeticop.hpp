...
class ArithmeticOpTranslator : public ScalarTranslator {
  public:
    ArithmeticOpTranslator(CMemoryPool *mp, CMDAccessor *mda) : ScalarTranslator(mp, mda) {}
    virtual ~ArithmeticOpTranslator() = default;
