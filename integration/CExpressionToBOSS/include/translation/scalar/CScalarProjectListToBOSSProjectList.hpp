...
class CScalarProjectListToBOSSProjectList : public ScalarTranslator {
 public:
  CScalarProjectListToBOSSProjectList() = default;
  ~CScalarProjectListToBOSSProjectList() override = default;
