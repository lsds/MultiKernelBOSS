...
class CScalarNullTestToBOSSScalarNullTest : public ScalarTranslator {
 public:
  CScalarNullTestToBOSSScalarNullTest() = default;
  ~CScalarNullTestToBOSSScalarNullTest() override = default;
